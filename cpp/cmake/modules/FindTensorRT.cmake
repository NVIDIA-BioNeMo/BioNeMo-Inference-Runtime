...
#
# This module defines TensorRT_FOUND if the tensorRT include dir is found or if
# the required libraries (COMPONENTS property in find_package) are found.
#
# A new imported target is created for each component (library) under the
# TensorRT namespace (TensorRT::${component_name})
#
# Note: this leverages the find-module paradigm [1]. The config-file paradigm
# [2] is recommended instead in CMake. [1]
# https://cmake.org/cmake/help/latest/manual/cmake-packages.7.html#config-file-packages
# [2]
# https://cmake.org/cmake/help/latest/manual/cmake-packages.7.html#find-module-packages

# Find headers
find_path(
  TensorRT_INCLUDE_DIR
  NAMES NvInferVersion.h REQUIRED
  PATHS ${TRT_ROOT_DIR}/include)
...
set(TensorRT_VERSION
    "${TRT_MAJOR_ENTERPRISE}.${TRT_MINOR_ENTERPRISE}.${TRT_PATCH_ENTERPRISE}")
...
find_trt_library(nvinfer_dispatch)
find_trt_library(nvinfer_lean)
...
find_package_handle_standard_args(
  ...
  REQUIRED_VARS TensorRT_INCLUDE_DIR # no need for libs/targets, since
