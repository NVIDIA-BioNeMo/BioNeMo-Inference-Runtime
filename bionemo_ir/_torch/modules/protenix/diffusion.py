...
from bionemo_ir._torch.auto_chunk import CHUNK_REGISTRY, DIFFUSION_PAIR_TRANSITION
...
class ProtenixSampleDiffusion(SampleDiffusion):
    ...
    def __init__(
        ...
        *,
        ...
        super().__init__(gamma0=gamma0, gamma_min=gamma_min, noise_scale=noise_scale, step_scale=step_scale)
    ...
    def denoise(self, x_noisy: torch.Tensor, sigma_hat: torch.Tensor, ctx: dict[str, Any]) -> torch.Tensor:
