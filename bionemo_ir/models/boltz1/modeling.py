...
from bionemo_ir._torch.modules.boltz.structure import AtomDiffusion, DiffusionConditioning
...
class Boltz1(nn.Module, OptimizedModuleSetterMixin):
    ...
    def forward(
        ...
        s_diffusion = struct_module_output["diff_token_repr"] if self.confidence_module_config.use_s_diffusion else None
