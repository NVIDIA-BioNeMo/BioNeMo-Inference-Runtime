...
from bionemo_ir._torch.layers.transformers.atom import AtomAttentionEncoder
...
from bionemo_ir.pipeline.models.boltz2.const import num_chain_types, num_method_types, num_tokens
