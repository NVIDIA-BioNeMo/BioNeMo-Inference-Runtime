...
class TestCIFWriterMultiPolymer:
    ...
    def writer(self):
        ...
        return CIFWriter(res_type_mapping=res_map,
                         atom_type_mapping=atom_map,
                         output_path="test.cif")
    ...
    def test_rna_only_heuristic_classification(self, writer):
        ...
        out = writer.write(rna_only_folding(sequence="AGC",
                                            with_residue_names=False,
    ...
    def test_multi_polymer_emits_all_chain_kinds(self, writer):
        ...
        out = writer.write(multi_polymer_folding(
            with_residue_names=True, with_mol_types=True))
        lines = out.split("\n")
    ...
    def test_write_to_file_contains_residue_names(self, tmp_path):
        ...
        writer = CIFWriter(res_type_mapping=res_map,
                           atom_type_mapping=atom_map,
