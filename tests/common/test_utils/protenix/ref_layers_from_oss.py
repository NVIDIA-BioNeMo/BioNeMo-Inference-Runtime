...
sys.path.insert(
    0, str(path_for_package_in_repo(tests).parent / "3rdparty/protenix"))

from protenix.model.modules.confidence import \
    ConfidenceHead as ProtenixOSS_ConfidenceHead  # noqa: E402
from protenix.model.modules.diffusion import \
    DiffusionConditioning as ProtenixOSS_DiffusionConditioning  # noqa: E402
from protenix.model.modules.diffusion import \
    DiffusionModule as ProtenixOSS_DiffusionModule  # noqa: E402
from protenix.model.modules.embedders import \
    ConstraintEmbedder as ProtenixOSS_ConstraintEmbedder  # noqa: E402
from protenix.model.modules.embedders import \
    RelativePositionEncoding as \
    ProtenixOSS_RelativePositionEncoding  # noqa: E402
from protenix.model.modules.head import \
    DistogramHead as ProtenixOSS_DistogramHead  # noqa: E402
from protenix.model.modules.pairformer import \
    MSAModule as ProtenixOSS_MSAModule  # noqa: E402
from protenix.model.modules.pairformer import \
    PairformerStack as ProtenixOSS_PairformerStack  # noqa: E402
from protenix.model.modules.pairformer import \
    TemplateEmbedder as ProtenixOSS_TemplateEmbedder  # noqa: E402
from protenix.model.modules.transformer import \
    AtomAttentionDecoder as ProtenixOSS_AtomAttentionDecoder  # noqa: E402
from protenix.model.modules.transformer import \
    AtomAttentionEncoder as ProtenixOSS_AtomAttentionEncoder  # noqa: E402
from protenix.model.modules.transformer import \
    AtomTransformer as ProtenixOSS_AtomTransformer  # noqa: E402
from protenix.model.protenix import \
    update_input_feature_dict  # noqa: E402,F401
from protenix.model.sample_confidence import \
    compute_contact_prob as oss_compute_contact_prob  # noqa: E402,F401
from protenix.model.sample_confidence import \
    compute_full_data_and_summary as \
    oss_compute_full_data_and_summary  # noqa: E402,F401
...
class RefProtenixAtomTransformerFromOSS(ProtenixOSS_AtomTransformer):
    ...
    def build(cls,
              *,
              ...
              n_queries: int = 32,
              n_keys: int = 128,
              seed: int = 42) -> "RefProtenixAtomTransformerFromOSS":
        torch.manual_seed(seed)
        return cls(c_atom=c_atom,
...
class RefProtenixAtomAttentionEncoderFromOSS(ProtenixOSS_AtomAttentionEncoder):
    ...
    def build(cls,
              *,
              ...
              n_queries: int = 32,
              n_keys: int = 128,
              seed: int = 42) -> "RefProtenixAtomAttentionEncoderFromOSS":
        torch.manual_seed(seed)
        return cls(has_coords=has_coords,
                   c_token=c_token,
                   c_atom=c_atom,
                   c_atompair=c_atompair,
                   c_s=c_s,
...
class RefProtenixRelativePositionEncodingFromOSS(
        ProtenixOSS_RelativePositionEncoding):
    ...
    def build(cls,
              *,
              ...
              s_max: int = 2,
              c_z: int = 256,
              seed: int = 42) -> "RefProtenixRelativePositionEncodingFromOSS":
        torch.manual_seed(seed)
...
class RefProtenixDistogramHeadFromOSS(ProtenixOSS_DistogramHead):
    ...
    def build(cls,
              *,
              c_z: int = 256,
              no_bins: int = 64,
              seed: int = 42) -> "RefProtenixDistogramHeadFromOSS":
        torch.manual_seed(seed)
...
class RefProtenixConfidenceHeadFromOSS(ProtenixOSS_ConfidenceHead):
    ...
    def build(cls,
              *,
              ...
              seed: int = 42) -> "RefProtenixConfidenceHeadFromOSS":
        torch.manual_seed(seed)
...
class RefProtenixTemplateEmbedderFromOSS(ProtenixOSS_TemplateEmbedder):
    ...
    def build(cls,
              *,
              ...
              hidden_scale_up: bool = True,
              seed: int = 42) -> "RefProtenixTemplateEmbedderFromOSS":
        torch.manual_seed(seed)
        return cls(n_blocks=n_blocks,
                   c=c,
                   c_z=c_z,
...
class RefProtenixConstraintEmbedderFromOSS(ProtenixOSS_ConstraintEmbedder):
    ...
    def build(cls,
              *,
              ...
              seed: int = 42) -> "RefProtenixConstraintEmbedderFromOSS":
        torch.manual_seed(seed)
        return cls(
            pocket_embedder={
                "enable": pocket,
...
class RefProtenixPairformerStackFromOSS(ProtenixOSS_PairformerStack):
    ...
    def build(cls,
              *,
              ...
              c_s: int = 64,
              hidden_scale_up: bool = True,
              seed: int = 42) -> "RefProtenixPairformerStackFromOSS":
        torch.manual_seed(seed)
        return cls(n_blocks=n_blocks,
                   n_heads=n_heads,
                   c_z=c_z,
...
class RefProtenixDiffusionConditioningFromOSS(ProtenixOSS_DiffusionConditioning
    ...
    def build(cls,
              *,
              ...
              seed: int = 42) -> "RefProtenixDiffusionConditioningFromOSS":
        torch.manual_seed(seed)
        return cls(sigma_data=sigma_data,
                   c_z=c_z,
                   c_s=c_s,
                   c_s_inputs=c_s_inputs,
...
class RefProtenixDiffusionModuleFromOSS(ProtenixOSS_DiffusionModule):
    ...
    def build(cls,
              *,
              ...
              token_n_heads: int = 4,
              seed: int = 42) -> "RefProtenixDiffusionModuleFromOSS":
        torch.manual_seed(seed)
        return cls(sigma_data=sigma_data,
                   c_atom=c_atom,
                   c_atompair=c_atompair,
                   ...
                   c_s_inputs=c_s_inputs,
                   atom_encoder={
                       "n_blocks": atom_n_blocks,
                       "n_heads": atom_n_heads
                   },
                   transformer={
                       "n_blocks": token_n_blocks,
...
class RefProtenixAtomAttentionDecoderFromOSS(ProtenixOSS_AtomAttentionDecoder):
    ...
    def build(cls,
              *,
              ...
              n_queries: int = 32,
              n_keys: int = 128,
              seed: int = 42) -> "RefProtenixAtomAttentionDecoderFromOSS":
        torch.manual_seed(seed)
        return cls(n_blocks=n_blocks,
                   n_heads=n_heads,
                   c_token=c_token,
...
class RefProtenixMSAModuleFromOSS(ProtenixOSS_MSAModule):
    ...
    def build(cls,
              *,
              ...
              c_s_inputs: int = 449,
              hidden_scale_up: bool = True,
              seed: int = 42) -> "RefProtenixMSAModuleFromOSS":
        torch.manual_seed(seed)
