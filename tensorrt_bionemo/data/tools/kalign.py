...
from tensorrt_bionemo import get_binary_path

KALIGN_BINARY_PATH = get_binary_path("kalign")
...
class Kalign:
    ...
    def __init__(self, binary_path: str = KALIGN_BINARY_PATH):
    ...
    def align(self, sequences: Sequence[str]) -> str:
        ...
        with tempfile.TemporaryDirectory(dir=".") as tmp_dir_name:
            input_fasta_path = os.path.join(tmp_dir_name, "input.fasta")
            output_a3m_path = os.path.join(tmp_dir_name, "output.a3m")
