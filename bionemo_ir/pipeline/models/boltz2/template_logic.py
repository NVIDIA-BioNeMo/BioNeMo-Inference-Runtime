...
Fresh BioIR reimplementation of the OSS ``boltz`` v2.2.1 template pipeline
...
from bionemo_ir.data.utils import normalize_gemmi_structure, read_gemmi_structure
...
def _load_modified_mol(name: str, mol_dir):
    ...
    Thin cached wrapper over :func:`bionemo_ir.data.utils.load_component_mol`
    ...
    from bionemo_ir.data.utils import load_component_mol
