...
from tensorrt_bionemo.pipeline.processor.base import Processor, ProcessorConfig, SerialProcessor, _ProcessorBase
from tensorrt_bionemo.pipeline.processor.utils import build_cpu_stage_map_kwargs, get_available_gpu_count
from tensorrt_bionemo.pipeline.stages import (
...
class EngineProcessorConfig(ProcessorConfig):
    ...
    engine_kwargs: dict[str, Any] = Field(
        ...
        description="The kwargs to pass to the tensorrt-bionemo engine. {'config': Optional[BaseConfig], 'accelerated_configs': Optional[Dict[str, AcceleratedConfig]]}",
    )
