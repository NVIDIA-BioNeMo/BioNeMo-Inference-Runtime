...
class DiskCache:
    ...
    Controls:
        BIOIR_KERNEL_CACHE_ENABLED=0  — disable (default: enabled)
        BIOIR_KERNEL_CACHE_DIR=path   — override default directory
    """

    ENABLED: bool = os.getenv("BIOIR_KERNEL_CACHE_ENABLED", "1") == "1"
    _CACHE_DIR: str | None = os.getenv("BIOIR_KERNEL_CACHE_DIR", None)
