...
from bionemo_ir.utils import str_dtype_to_torch, torch_dtype_to_str
from bionemo_ir.version import __version__
...
class BaseConfig(BaseModel):
    ...
    # marks this module for wrapping by ``bioir_apply_graph_optimization`` /
