...
class Logger:
    ...
    def __init__(self) -> None:
        requested_level = os.environ.get("BIOIR_LOG_LEVEL", "error").lower()
        self._level = requested_level if requested_level in _LEVELS else "error"
        self._appeared_keys: set[object] = set()
        self._logger = logging.getLogger("BioIR")
