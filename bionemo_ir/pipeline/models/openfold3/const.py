...
# 1-letter protein code to restype index. Mirrors OSS
# ``PROTEIN_RESTYPE_1TO3`` (20 standard amino acids + ``X`` → ``UNK``).
_PROTEIN_1TO3 = {
    "A": "ALA",
    "R": "ARG",
    "N": "ASN",
    ...
    "Y": "TYR",
    "V": "VAL",
    "X": "UNK",  # unknown protein; RESTYPES_3 / RESTYPES_1 index 20
}
