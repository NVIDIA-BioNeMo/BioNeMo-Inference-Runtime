...
from bionemo_ir._torch.tensor_utils import tensor_tree_map
...
class OpenFold3(nn.Module, OptimizedModuleSetterMixin):
    ...
    GRAPH_OPT_ENABLED_MODULES = {
        ...
        "token_transformer": "sample_diffusion.diffusion_module.diffusion_transformer",
    ...
    def __init__(
        ...
        self.diffusion_module = DiffusionModule(config=self.config.diffusion_module_config)
